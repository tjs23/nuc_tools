...
def contact_boundaries(region_path, contact_paths, pdf_path, bin_size=DEFAULT_BIN_SIZE, labels=None,
...
def main(argv=None):
  ...
  contact_boundaries(region_path, contact_paths, pdf_path, bin_size,
